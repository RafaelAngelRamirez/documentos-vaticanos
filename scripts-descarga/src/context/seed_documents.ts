...
const MAGISTERIUM: MagDoc[] = [
  ...
  { id: 'cceo-la', profile: 'issuer-canon-law', years: '1990', summary: 'Código de los Cánones de las Iglesias Orientales.', chrono: 'Juan Pablo II; paralelismo oriental al CIC 83.', refs: [R.cceo, R.jpii] },
