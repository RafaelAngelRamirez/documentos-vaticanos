...
/**
 * AI-translation disclaimer (aligned with pipeline `looksLikeAiDisclaimer`).
 * Do not use `traducci[oó]n.*IA`: with `/i` it matches «traducción de referencia».
 */
export function looksLikeAiDisclaimer(note?: string | null): boolean {
  ...
  return (
    ...
    /generated by AI/i.test(note) ||
    /AI[- ]generated/i.test(note) ||
    /\bAI translation\b/i.test(note) ||
...
export function isAiEdition(meta: LocaleMeta): boolean {
  ...
  if (looksLikeAiDisclaimer(meta.sourceNote)) return true;
